...
public class LocalDateTest {
    ...
    public static void main(String[] args) {
        ...
        boolean before = LocalDate.parse("2019-03-01").isBefore(LocalDate.parse("2019-02-28"));
        ...
        LocalDate with = LocalDate.parse("2019-03-11").with(TemporalAdjusters.firstDayOfMonth());
